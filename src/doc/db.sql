...
insert  into `tb_board`(`id`,`name`,`description`,`state`,`stateDisplay`,`createTime`) values (1,'Android','安卓学习历程',100,'上线','2017-05-30 11:16:12'),(2,'Kotlin','Kotlin学习历程',100,'上线','2017-05-30 11:16:16');
